...
bool Initialize::CheckMemory(const DWORDLONG physicalRAMNeeded, const DWORDLONG virtualRAMNeeded) {
...
int Initialize::StartUp(_In_ HINSTANCE hInstance,
	...
	_In_ int nCmdShow)
{
	...
	Initialize::CheckInstance();
	Initialize::CheckStorage(300 * 1024 * 1024);
	Initialize::CheckMemory(69, 420);
	Initialize::ReadCPUSpeed();
